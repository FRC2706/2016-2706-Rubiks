...
public class RotateDriveWithHybrid extends Command {
    ...
    private final DrivePIDOutput leftOut =
                    (DrivePIDOutput) Robot.driveTrain.getDrivePIDOutput(false, true);
    private final DrivePIDOutput rightOut =
                    (DrivePIDOutput) Robot.driveTrain.getDrivePIDOutput(true, false);
    ...
    public RotateDriveWithHybrid(double speed, int minDoneCycles) {
        ...
        leftPID = new PIDController(P, I, D, F, Robot.driveTrain.getGyroPIDSource(false), leftOut);
