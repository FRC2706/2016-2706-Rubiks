...
/**
 * A very simple two-stage proportional control for quickly rotating the robot heading based on
 * gyro. Note this uses the current gyro heading and does NOT reset it. Note that the input heading
 * is ABSOLUTE (gyro based) and not relative to current position, i.e. "90" means face the robot due
 * east (relative to the gyro heading), not turn 90 degrees from wherever it is now.
 */
